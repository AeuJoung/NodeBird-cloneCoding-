"use client"
//onclick 등 이벤트 함수나 훅을 사용할 경우에는 클라이언트 페이지어야 됨. 

import { useSelectedLayoutSegment } from "next/navigation";
import Link from "next/link";
import style from "@/app/(afterLogin)/_component/nevMenu.module.css"

export default function NavMenu() {
    const segment : string | null = useSelectedLayoutSegment();
    //useSelectedLayoutSegment : 레이아웃 기준 현재 경로 'compose'
    //useSelectedLayoutSegments : 세부 페이지 기준 현재 경로 '{'compose', 'tweet'}
